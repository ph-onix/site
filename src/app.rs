use crate::{
    app::Icon::{Copyright, LuMail, RaGithubLogo},
    components::{BuildLog, Hero, Nav, ProjectCatalog},
};
use leptos::prelude::*;
...
impl fmt::Display for Icon {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Icon::Copyright => write!(f, "Copyright"),
        }
    }
}
    ...
    view! {
        ...
        <html lang="en">
            ...
            <body>
                ...
                <svg hidden>
                    <symbol id=Icon::Copyright.to_string() viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    view! {
        ...
        <div class="home-content nav-align">
            ...
            <footer role="contentinfo" aria-label="Footer">
                <p>
                    <span>{Copyright.into_view()} Pheonx Miller</span>
                ...
                <div>
                    <a href=MAILTO_EMAIL>
                        <span aria_hidden>{LuMail.into_view()}</span>
                        {EMAIL}
                    </a>
                    <a href=GITHUB_URL target="_blank" rel="noreferrer noopener" aria_label="GitHub">
                        <span aria_hidden>{RaGithubLogo.into_view()}</span>
                    </a>
                </div>
            </footer>
        </div>
